...
/** This message contains the maximum speed and acceleration of the joint. */
#define RS485_MSG_SPEED_ACCEL_MAX 0x22

/** This message contains the maximum current and torque of the joint. */
#define RS485_MSG_CURRENT_TORQUE_MAX 0x23
